                        ...
                        <tr class="tw-text-xs">
                            ...
                            <td class="text-center"> 
                                <div class="d-flex align-items-center gap-10 justify-content-center">
                                    ...
                                    @endcan
                                    @can('order_delete')
                                    <button type="button" wire:click="deleteOrder({{$item->id}})" wire:confirm="{{ $lang->data['are_you_sure'] ?? 'Are you sure you want to delete this order?' }}" class="remove-item-button bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium tw-size-8 d-flex justify-content-center align-items-center rounded-circle"> 
